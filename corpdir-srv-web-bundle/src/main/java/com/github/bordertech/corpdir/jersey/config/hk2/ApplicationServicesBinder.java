...
public class ApplicationServicesBinder extends AbstractBinder {
	...
	protected void configure() {
		...
		bind(SystemCtrlReadOnlyServiceImpl.class).to(SystemCtrlReadOnlyService.class).in(Singleton.class);
		...
		bind(SystemCtrlWriteServiceImpl.class).to(SystemCtrlWriteService.class).in(Singleton.class);
	}
}
