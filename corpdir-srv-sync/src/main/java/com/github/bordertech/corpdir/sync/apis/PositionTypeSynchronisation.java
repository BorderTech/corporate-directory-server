 ...
 * @since 1.0.0
 */
public class PositionTypeSynchronisation extends AbstractKeyIdSynchronisation<PositionType, PositionTypeReadOnlyService, PositionTypeService, PositionTypeMapper> {
