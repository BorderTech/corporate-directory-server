 ...
 */
public class DefaultCorpCrudTreeDataApiTemp<T extends ApiTreeable, R extends BasicTreeReadOnlyService<T>, W extends BasicTreeWriteService<T>> extends DefaultCorpCrudDataApiTemp<T, R, W> implements CorpCrudTreeDataApiTemp<T, R, W> {

	public DefaultCorpCrudTreeDataApiTemp(final Class<T> apiClass, final R readService, final W writeService) {
