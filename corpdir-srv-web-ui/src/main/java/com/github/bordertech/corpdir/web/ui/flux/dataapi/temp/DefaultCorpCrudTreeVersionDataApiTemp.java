 ...
 */
public class DefaultCorpCrudTreeVersionDataApiTemp<T extends ApiTreeable & ApiVersionable, R extends BasicVersionTreeReadOnlyService<T>, W extends BasicVersionTreeWriteService<T>> extends DefaultCorpCrudTreeDataApiTemp<T, R, W> implements CorpCrudTreeVersionDataApiTemp<T, R, W> {

	public DefaultCorpCrudTreeVersionDataApiTemp(final Class<T> apiClass, final R readService, final W writeService) {
