 ...
 */
public interface CorpCrudTreeActionCreatorTemp<T extends ApiTreeable, D extends CorpCrudTreeDataApiTemp<T, ?, ?>> extends CorpCrudActionCreatorTemp<T, D>, DataApiCrudTreeActionCreator<String, T, D> {
